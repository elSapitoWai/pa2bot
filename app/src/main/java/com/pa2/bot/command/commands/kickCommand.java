...
public class kickCommand implements ICommands {
    ...
    public void handle(CommandContext ctx) {
        ...
        ctx.getGuild()
                ...
                .reason(reason)
                .queue(
                        (__) -> channel.sendMessage("Has been successfully kicked").queue(),
                        (error) -> channel.sendMessage("Couldn't kick: " + error.getMessage())
                        .queue()
                );
    }
